...
<head>
    ...
    <title>Contact - Grape World</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <p class="lead">Email: grapes@grapeworld.com</p>
                    <p class = "lead">Telephone: 02012 345 678</p>
                    <p class = "lead"><b>Address</b></p>
                    <p class = "lead">1 Grape Street</p>
                    <p class = "lead">London</p>
                    <p class = "lead">GR4 4PE</p>
                </div>
