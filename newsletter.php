...
<div class="content-section-a">
    ...
    <div class="container">
        ...
        <!-- /.container -->
        <div class="col-lg-5 col-lg-offset-4 col-sm-4">
            <form action = "subscribe.php" method = "post"><input type = "text" name = "email" size = "40"> <input type = "submit" value = "Subscribe"></form>
        </div>
    </div>
    <!-- /.content-section-a -->
